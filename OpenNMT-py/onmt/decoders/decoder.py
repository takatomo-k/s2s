...
from onmt.modules import context_gate_factory, GlobalAttention, MultiHeadedAttention
...
class RNNDecoderBase(DecoderBase):
    ...
    def __init__(self, rnn_type, bidirectional_encoder, num_layers,
                 ...
                 reuse_copy_attn=False, copy_attn_type="general",noise=0):
    ...
    def from_opt(cls, opt, embeddings):
        ...
        return cls(
            opt.rnn_type,
            opt.brnn or opt.encoder_type=="audio",
            opt.dec_layers,
            opt.dec_rnn_size,
    ...
    def forward(self, tgt, memory_bank, memory_lengths=None, step=None, tgt_lengths=None):
        """
        Args:
...
class StdRNNDecoder(RNNDecoderBase):
    ...
    def _run_forward_pass(self, tgt, memory_bank, memory_lengths=None):
        ...
        attns = {}
        emb = self.noise(self.embeddings(tgt))
        ...
        if not self.attentional:
            ...
            dec_outs, p_attn, context = self.attn(
